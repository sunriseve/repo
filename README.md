# 🌌 skystream-repo
skystream-repo is an extension repo for [SkyStream](https://github.com/akashdh11/skystream). Follow the guide below to get started and set up your providers.
...
4.  Enter the following Repository URL:
    > **Repository URL:** `https://raw.githubusercontent.com/sunriseve/repo/main/repo.json`
5.  Tap **Add**.
